...
## 2.1 [二分查找](https://leetcode-cn.com/problems/binary-search/)
...
## 2.2 [排序数组](https://leetcode-cn.com/problems/sort-an-array/)
    ...
    def lengthOfLongestSubstring(self, s: str) -> int:
        ...
        for right, rightvalue in enumerate(s):
            if rightvalue in last_idx and last_idx[rightvalue] >= left:
                ...
                left = last_idx[rightvalue] + 1  # 滑动窗口，只不过左端不需要收缩，用last_idx代替了l += 1
